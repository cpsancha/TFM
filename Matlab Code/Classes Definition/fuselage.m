classdef fuselage < handle
    ...
    properties (SetObservable)
        ...
        galleryLength    double    %[double] Length of the gallery [m]
        lavatoryLength   double    %[double] Length of the lavatory [m]
        passengersLength double    %[double] Length of the passengers cabin without lavatory or gallery [m]
    end

...
switch ME.MissionType
    case 5
        ...
        Parameters.Cruise.c_j = [0.5, 0.9]*CF.TSFC2SI;  %lbm/lbf/hr to kg/(N新)
...
switch ME.MissionType
    case 5
        ...
        %en el tiempo de subir a 12.500m (16 min) el avi鏮 recorrer燰 160 km
...
%% Breguet愀 equation to get fuel fraction during cruise and loiter:

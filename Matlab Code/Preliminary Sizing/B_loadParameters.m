...
switch ME.MissionType
    case 5
        ...
        Parameters.EngineOptions(1).Diameter = 0.978; %[m]
        Parameters.EngineOptions(1).Length   = 2.705; %[m]
        ...
        Parameters.EngineOptions(2).Weight   =  750; %[kg] dry weight
        Parameters.EngineOptions(2).TSFC     = 0.594; %[lb/(lbf·h)] at cruise 0.95*0.628
        Parameters.EngineOptions(2).Diameter = 1.080; %[m]
        Parameters.EngineOptions(2).Length   = 1.900; %[m]
        
        % [X] 2*Snecma Silvercrest --> Dassault Falcon 5X
        Parameters.EngineOptions(3).Model    = 'Snecma Silvercrest 2D';
        Parameters.EngineOptions(3).Thrust   =  50.9; %[kN] at sea level (50.9kN)
        Parameters.EngineOptions(3).Weight   =  750; %[kg] dry weight
        Parameters.EngineOptions(3).TSFC     = 0.594; %[lb/(lbf·h)] at cruise 0.95*0.628

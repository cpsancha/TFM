...
Pw = (W_P.cl.AOE.*CF.hp2watts./(CF.lbm2kg.*CST.GravitySI)).^-1;
PWinv = (W_P.cl.AOE.^-1).*(CF.hp2watts./(CF.lbm2kg.*CST.GravitySI)^-1);
figure(8)
hold on
plot(Wto_S_cl,P_W.cl.FAR2365,'*','DisplayName','23.65')
plot(Wto_S_cl,Pw,'DisplayName','pw')
plot(Wto_S_cl,PWinv,'DisplayName','pWinv')
legend('show')
figure()
%%%%%%%%%%%%%%%%
% FAR 23.67 OEI

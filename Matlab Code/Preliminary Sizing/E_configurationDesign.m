...
%% ENGINE TYPE, NUMBER AND DISPOSITION --> Chapter 5
    ...
    % Options:
        ...
        % [X] 2*Snecma Silvercrest (50.9–53 kN) --> ~100kN ~kg ~lb/(lbf·h)--> Dassault Falcon 5X - Cessna Citation Hemisphere
        % [ ] 2*Rolls-Royce BR710A2-20 (65.6kN) --> ~130kN ~kg ~lb/(lbf·h)--> Bombardier Global 5000
